...
mkAssetMap = let
  ...
  em = [ mkMonster "Player" "The Hero (@)"  pos
       ...
       , mkItem "shoot/Longbow"         "}:1d8:2:Ammo"         pos
       ...
       -- shoot Elvish
       , mkItem "shoot/Elvish Bow"      "}:2d4:2:Ammo" pos
       ...
       , mkItem "feet/Boots of Speed"     "]:100:1:DEX" pos
       ...
       , mkItem "hands/Gauntlets of Ogre"   "]:100:1:STR" pos
       ...
       , mkItem "cloak/Cloak of Elements"    "(:100:1:INT,FIRE,COLD" pos
