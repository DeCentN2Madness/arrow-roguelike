  ...
  monsters
    ...
    | depth >= 15 && depth < 17 =
      concat [ insertRand shrooms 1  10 openList
             ...
             , insertRand blackDragon 111 120 bottomRight
             ]
    | depth >= 12 && depth < 15 =
      concat [ insertRand shrooms 1  10 openList
             , insertRand corpses 11 20 openList
             ...
             , insertRand necros      71 80  openList
             , insertRand spiders     81 90  bottomLeft
             , insertRand blackDragon 91 100 bottomRight
             ]
    | depth >= 8 && depth < 11 =
      concat [ insertRand shrooms 1  10 openList
             , insertRand corpses 11 20 openList
             ...
             , insertRand orcArcher 81 90  bottomLeft
             , insertRand spiders   91 100 bottomRight
             ]
    | depth >= 5 && depth < 8 =
      concat [ insertRand shrooms 1  10  openList
             , insertRand corpses 11 20  openList
             ...
             , insertRand dires     61 70  bottomLeft
             , insertRand goblins   71 80  bottomLeft
             , insertRand skeletons 81 90  bottomRight
             , insertRand zombies   91 100 bottomRight
             ]
   | depth >= 2  && depth < 5 =
     concat [ insertRand shrooms 1  10 openList
            , insertRand corpses 11 20 openList
